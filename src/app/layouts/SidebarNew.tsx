...
const menu = [
  ...
  { id: "attendance", title: "Attendance", icon: CalendarCheck, path: "/attendance" },
  {
    ...
    icon: Receipt,
    children: [
      { id: "expenses-all", title: "All Expenses", path: "/expenses" },
      { id: "expenses-add", title: "Add Expense", path: "/expenses/add" },
      { id: "expenses-budgets", title: "Budgets", path: "/expenses/budgets" },
    ],
  },
  {
    id: "billing",
    ...
    icon: Receipt,
    children: [
      { id: "billing-overview", title: "Overview", path: "/billing" },
      { id: "billing-add", title: "Create Invoice", path: "/billing/invoices/add" },
      { id: "billing-payments", title: "Payments", path: "/billing/payments" },
    ],
  },
  { id: "finance", title: "Finance", icon: Wallet, path: "/finance" },
